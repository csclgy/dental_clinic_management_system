                            ...
                            <div className="row">
                                <div className="col-sm-8">
                                 ...
                                 <div className="col-sm-2">
                                        <button class="bg-[#00c3b8] text-white font-semibold px-6 py-2 rounded-full w-full mb-4" onClick={() => navigate("/admininventory")}>Back</button>
                                </div>
                                <div className="col-sm-2">
                                        <button class="bg-[#00c3b8] text-white font-semibold px-6 py-2 rounded-full w-full mb-4" onClick={() => navigate("/adminsupplieradd")}>Add</button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-sm-12 p-10 rounded-lg shadow-lg" style={{border:"solid", borderColor:"#01D5C4"}}>
                          ...
                          filteredRecords.map((record, index) => (
                            ...
                            >
                              ...
                              <td className="px-4 py-2 text-blue-700">{record.contact_person}</td>
