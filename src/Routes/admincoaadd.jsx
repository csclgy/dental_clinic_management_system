                ...
                <div className="col-sm-7">
                    <div className="row">
                        ...
                        <div className="col-sm-12 p-10 rounded-lg shadow-lg" style={{border:"solid", borderColor:"#01D5C4"}}>
                            <div className="row">
                                    <h1 className="text-xl font-bold" style={{ color: "#00458B" }}>Add New Account</h1>
                                    ...
                                    <div className="col-sm-12">
                                        ...
                                        <div className="col-sm-6">
                                            ...
                                            <div className="col-sm-6">
                                                <button class="bg-[#00c3b8] text-white font-semibold px-6 py-2 rounded-full w-full mb-4" onClick={() => navigate("/admincoa")}>Save</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
