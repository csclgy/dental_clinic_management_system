...
import { BarChart3, Users, Calendar, Menu, X, ChevronDown, ChevronUp, PhilippinePeso, IdCard, Printer, Settings, FolderKanban, BriefcaseMedical } from "lucide-react";
            ...
            <>
              ...
              {isLedgerOpen && (
                <div className="ml-6 flex flex-col gap-1 text-sm">
                  ...
                  <Link to="/admintrial" className="flex items-center gap-2 bg-white text-[#00458B] p-2 rounded-lg hover:bg-white hover:text-[#00458B]">
                    Trial Balance
                  </Link>
                </div>
              )}
                  ...
                  filteredRecords.map((record, index) => (
                    <tr key={index} className="border-b border-gray-200">
                      ...
                      <td className="px-4 py-2 text-center">
                        {Number(record.debit).toLocaleString("en-PH", {
                          minimumFractionDigits: 2,
                        })}
                      </td>
                      <td className="px-4 py-2 text-center">
                        {Number(record.credit).toLocaleString("en-PH", {
                          minimumFractionDigits: 2,
                        })}
                      </td>
                    </tr>
