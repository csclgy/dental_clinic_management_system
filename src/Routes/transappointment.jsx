        ...
        <div className="container-fluid">
          <div className="row">
            <div className="col-sm-3">
                ...
                <br />
                <Link to ="/transmed" >
                    <button  className="w-full text-left px-4 py-2 text-500 hover:bg-blue-100" style={{color:"#00458B"}}><i class="fa fa-user-circle-o" aria-hidden="true"></i> Medical Records</button>
                </Link>
                <br />
                <Link to ="/transappointment">
                    <button className="w-full text-left px-4 py-2 text-500 hover:bg-blue-100 " style={{color:"#01D5C4"}}><i class="fa fa-history" aria-hidden="true"></i> Appointment History</button>
                </Link>
                <br />
            </div>
