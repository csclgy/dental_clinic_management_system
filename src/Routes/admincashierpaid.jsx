...
const AdminCashierPaid = () => {
  ...
  useEffect(() => {
    const fetchConsultations = async () => {
      try {
        ...
        const res = await fetch("https://dental-clinic-management-system-backend-jlz9.onrender.com/auth/displayconsultations2", {
  ...
  const filteredRecords = records.filter((record) => {
    return (
      record.payment_status?.toLowerCase().trim() === "paid" &&
...
export default AdminCashierPaid;