        ...
        <div className="mt-6">
          <button
            className={`font-semibold px-6 py-2 rounded-full w-full ${
              appointmentData.procedure_type && appointmentData.pref_date && appointmentData.pref_time
                ? "bg-[#00c3b8] text-white hover:bg-teal-600"
                : "bg-gray-300 text-gray-500 cursor-not-allowed"
            }`}
            disabled={!appointmentData.procedure_type || !appointmentData.pref_date || !appointmentData.pref_time}
            onClick={() => {
