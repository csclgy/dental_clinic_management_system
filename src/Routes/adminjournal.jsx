                  ...
                  {filteredRecords.length > 0 ? (
                    filteredRecords.map((record, index) => (
                      <tr key={index} className="border-b border-gray-200">
                        ...
                        <td className="px-4 py-2 text-black">{record.description}</td>
                        <td className="px-4 py-2 text-black">₱ {record.debit}</td>
                        <td className="px-4 py-2 text-black">₱ {record.credit}</td>
                        <td className="px-4 py-2 text-black">{record.comment}</td>
                      </tr>
                    ))
                  ) : (
                    <tr>
