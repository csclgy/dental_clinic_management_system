...
function InventoryDashboard() {
  ...
  const lowStock = inventory.filter((item) => Number(item.inv_quantity) <= 10).length;
  ...
  const lowCount = inventory.filter((item) => Number(item.inv_quantity) <= 10).length;
        ...
        {loading ? (
          ...
          <>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md border border-gray-200">
              ...
              {inventory.filter((item) => Number(item.inv_quantity) <= 10).length > 0 ? (
                <table className="w-full border-collapse border border-gray-200">
                  <thead>
                    <tr className="bg-gray-100 text-[#00458B]">
                      <th className="px-4 py-2 text-left">Item Name</th>
                  ...
                  <tbody>
                    {inventory
                      .filter((item) => Number(item.inv_quantity) <= 10)
                      .map((item) => (
                        <tr key={item.inv_id} className="border-b border-gray-200">
                          <td className="px-4 py-2">{item.inv_item_name}</td>
                          <td className="px-4 py-2 text-center">{item.inv_quantity}</td>
