...
import { BarChart3, Users, Calendar, Menu, X, ChevronDown, ChevronUp, PhilippinePeso, IdCard, PlusCircle, Printer, Settings, FolderKanban, BriefcaseMedical } from "lucide-react";
      ...
      <aside className="hidden md:flex w-64 bg-[#00458B] text-white flex-col p-6">
        ...
        <nav className="flex flex-col gap-2">
          ...
          {(role === "admin" || role === "dentist" || role === "receptionist") && (
            <>
              <Link to="/adminpatients" className="flex items-center gap-2 bg-white text-[#00458B] p-2 rounded-lg hover:bg-white hover:text-[#00458B]">
