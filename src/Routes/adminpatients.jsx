...
const AdminPatients = () => {
  ...
  const confirmDelete = async () => {
    ...
    try {
      ...
      // ✅ Auto close success box after 2.5s
      setTimeout(() => {
        setAlertBox({ show: false, message: "", patientId: null, type: "" });
      }, 2500);
    } catch (err) {
  ...
  return (
    <div className="p-4">
                        ...
                        filteredRecords.map((record) => (
                          ...
                          >
                            ...
                            <td className="px-4 py-2 flex gap-2 justify-center">
                              ...
                              <button
                                onClick={() => handleDeleteClick(record.user_id)}
      ...
      {/* 🔹 Confirm Delete Alertbox */}
      {alertBox.show && alertBox.type === "confirm" && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
          <div className="bg-white rounded-lg shadow-lg p-6 w-96 text-center">
            <h2 className="text-lg font-bold mb-4 text-[#00458B]">Confirm Delete</h2>
            <p className="text-gray-700 mb-6">{alertBox.message}</p>
            <div className="flex justify-center gap-4">
              ...
              <button
                className="bg-[#f44336] text-white font-semibold px-6 py-2 rounded-full"
      ...
      {/* 🔹 Success Alertbox */}
      {alertBox.show && alertBox.type === "success" && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
          <div className="bg-white rounded-lg shadow-lg p-6 w-[300px] text-center">
            <h2 className="text-lg font-bold mb-4 text-green-600">Success</h2>
            <p className="text-gray-700">{alertBox.message}</p>
          </div>
        </div>
      )}
    </div>
