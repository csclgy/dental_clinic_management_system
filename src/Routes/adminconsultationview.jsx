                  ...
                  {photos.length > 0 ? (
                    photos.map((photo, idx) => (
                      <button
                        ...
                        onClick={() => window.open(`https://dental-clinic-management-system-frontend-wipu.onrender.com/uploads/appointments/${photo.up_url}`, "_blank")
                        }
                      >
                        View Image {idx + 1}
                      </button>
                ...
                {consultation.downpayment_proof && (
                  <div className="mt-4">
                    ...
                    <button
                      onClick={() =>
                        window.open(
                          `https://dental-clinic-management-system-frontend-wipu.onrender.com/uploads/appointments/${consultation.downpayment_proof}`,
                          "_blank"
                        )
                      }
                  ...
                  <>
                    ...
                    {cancelInfo.refund_photo ? (
                      <button
                        onClick={() =>
                          window.open(
                            `https://dental-clinic-management-system-frontend-wipu.onrender.com/uploads/appointments/${cancelInfo.refund_photo}`,
                            "_blank"
                          )
                        }
