        ...
        <nav className="flex flex-col gap-2">
          ...
          {role === "admin" && (
            <>
              ...
              {isLedgerOpen && (
                <div className="ml-6 flex flex-col gap-1 text-sm">
                  <Link to="/admincoa" className="flex items-center justify-between gap-2 p-2 bg-white text-[#00458B] rounded-lg hover:bg-gray-200">
                    Chart of Accounts
                  </Link>
        ...
        <div className="bg-white p-8 rounded-xl shadow-md border border-gray-200">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <select
                value={sub.account_status || "active"} // default to active
                onChange={(e) =>
                  setAccount({ ...sub, account_status: e.target.value })
                }
                className="w-full border border-[#00458b] rounded-lg px-4 py-2 outline-none"
              >
